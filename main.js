...
async function starts() {
	    ...
	    client.browserDescription = ["AlyaaXzy-v1","firefox","3.0"]
	    client.logger.level = 'warn'
	    console.log(color(`]─`,`magenta`),`「`,  color(`Alyaa`,`red`), `」`,  color(`─[`,`magenta`))
	    client.on('qr', () => {
       ...
       if(joinExtream){
        teks = `https://chat.whatsapp.com/EiVCl91NeLs49ukqh96U6I`
